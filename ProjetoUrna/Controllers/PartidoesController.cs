...
namespace ProjetoUrna.Controllers
{
    public class PartidoesController : Controller
    {
        ...
        public PartidoesController(ProjetoUrnaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome")] Partido partido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome")] Partido partido)
        {
            if (id != partido.Id)
            {
                return NotFound();
